...
description: Agent guide for clAMM management on Arcadia Finance. Covers 37 MCP tools (+1 dev), automation setup (rebalancers, compounders, yield claimers, Merkl, CoW swapper), strategy selection framework, and strategy templates including delta neutral leveraged LP and protocol-owned liquidity.
user-invocable: true
---
