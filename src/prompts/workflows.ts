      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "",
              "Steps:",
              "1. Call read.account_info to get health factor, collateral, debt, positions, and automation status",
              "2. Call read.account_pnl to check profitability and yield earned",
              "3. If leveraged (health_factor < 1), call read.lending_pools to compare borrow APY vs fee APY",
              "4. Call read.recommendation to check if rebalancing is needed",
              "",
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "",
              "Steps:",
              "1. Call read.strategies(featured_only: true) to see top LP strategies with fee APY",
              "2. Call read.strategies(strategy_id: <id>) for promising ones to see APY per range width",
              "3. Call read.lending_pools to check borrow APY for leveraged strategies",
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "",
              "Steps:",
              "1. Call read.account_info to check current positions and which asset managers are already enabled",
              "2. Identify the LP protocol (Slipstream V1/V2, Uniswap V3/V4) from the position",
              "3. For each automation type to enable, use write.configure_asset_manager:",
              "   - Rebalancer: match to LP protocol, set trigger ratios and compound_leftovers",
              "   - Compounder: match to LP protocol (compounds fees between rebalances)",
              "   - Yield Claimer: match to LP protocol, set fee_recipient",
              "   - Merkl Operator: set reward_recipient",
              "",
