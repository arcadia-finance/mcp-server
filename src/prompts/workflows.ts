      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "",
              "Steps:",
              "1. Call get_account_info to get health factor, collateral, debt, positions, and automation status",
              "2. Call get_account_pnl to check profitability and yield earned",
              "3. If leveraged (health_factor < 1), call get_lending_pools to compare borrow APY vs fee APY",
              "4. Call get_recommendation to check if rebalancing is needed",
              "",
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "",
              "Steps:",
              "1. Call get_strategies(featured_only: true) to see top LP strategies with fee APY",
              "2. Call get_strategies(strategy_id: <id>) for promising ones to see APY per range width",
              "3. Call get_lending_pools to check borrow APY for leveraged strategies",
      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "",
              "Steps:",
              "1. Call get_account_info to check current positions and which asset managers are already enabled",
              "2. Identify the LP protocol (Slipstream V1/V2, Uniswap V3/V4) from the position",
              "3. For each automation type to enable, use build_configure_asset_manager_tx:",
